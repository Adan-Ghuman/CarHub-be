...
try {
    ...
    $booking_sql = "SELECT 
                        ...
                        SUM(CASE WHEN MONTH(booking_date) = MONTH(NOW()) AND YEAR(booking_date) = YEAR(NOW()) AND status = 'completed' THEN total_amount ELSE 0 END) as monthly_revenue,
    ...
    $popular_sql = "SELECT 
                    ...
                    LEFT JOIN workshop_bookings b ON s.id = b.service_id
